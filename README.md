...
`PaymentMethodPolicy` lets callers accept or reject the crate's payment-method categories without
embedding merchant or workflow configuration in `PaymentMethodType`.
